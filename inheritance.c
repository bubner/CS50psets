...
person *create_family(int generations)
{
    ...
    if (generations > 1)
    {
        ...
        // -> operator accesses members of a struct using pointers and objects similar to . but instead is for pointers
...
void free_family(person *p)
{
    ...
    // Runs over this function and releases memory for each person
